					...
					<form class="mt-3 px-4" method="post" 
						...
						<input type="submit" 
							...
							<p class="text-center py-3">Do you alredy have an account? | 
								<a href="<?php echo $ruta;?>ingreso_en">Login</a>
							</p>
					</form>
				</figure>
			</div>
