				...
				<figure class="p-2 p-sm-5 p-lg-4 p-xl-5 text-center">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item">
									<form method="post" 
										...
										<input type="submit" value="ES" style="border:0; background: transparent; padding:0; margin: 0; cursor: pointer;" >
									</form>
								</a>
							</div>
						</div>
					...
					<form method="post" class="mt-5">
						...
						<input type="email" class="form-control my-3 py-3" 
							placeholder="Email" name="ingresoEmail" required>
						...
						<input type="submit" class="form-control my-3 py-3 btn btn-info" 
							value="Login">
						<p class="text-center pt-1">Do not you have an account yet? | 
							<a href="<?php echo $ruta;?>registro_en">Sign up</a>
						</p>
						<p class="text-center pt-1">
							<a href="#modalRecuperarPassword" data-toggle="modal"
								data-dismiss="modal">Forgot your password?						
							</a>
						</p>
					</form>
				</figure>
