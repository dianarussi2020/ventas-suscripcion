<div class="card card-purple card-outline">
	<div class="card-header">
		<h3 class="card-title">
			<a href="cuerpo-activo" class="text-muted">
				<i class="fas fa-heart text-purple"></i> Cuerpo Activo
			</a>
		</h3>
		<div class="card-tools">
			<button type="button" class="btn btn-purple btn-sm" data-widget="collapse" 
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3 class="card-title">
			<a href="mente-sana" class="text-muted">
...
<div class="card card-primary card-outline">
	<div class="card-header">
		<h3 class="card-title">
			<a href="espiritu-libre" class="text-muted">
				<i class="fas fa-wind text-primary"></i> Espíritu Libre
			</a>
		</h3>
		<div class="card-tools">
