<div class="col-12 col-md-8">
	<div class="card card-primary card-outline">
		...
		<div class="card-body">
			...
			<br>
			<p class="card-text">
				Al activar su membresía mensual ingresa en nuestro programa de afiliados, 
				el cual podrá generar ingresos extras de forma consecutiva gracias 
				a la red multinivel que puede hacer con nosotro, 
				más información ingrese a la página 
				<a href="plan-compensacion">Plan compensación.</a>
			</p>
			...
			<div class="form-group">
				...
				<span>(Compartiendo este enlace podrá ganar comisiones, más información: 
					<a href="plan-compensacion">Plan de compensación</a>)
				</span>
			...
			<div class="form-group">
				<label for="iputPais" class="control-label">País</label>
				<div>
			...
			<div class="form-group">
				<label for="iputMovil" class="control-label">Teléfono móvil</label>
				<div class="input-group">
					<div class="input-group-prepend">
					...
					<div class="col-sm-offset-2">
						<div class="checkbox" >
							...
							<label for="aceptarTerminos">
								<span></span>Yo acepto los <a href="#terminos" 
									data-toggle="collapse">términos y condiciones</a>
							</label>
							<a href="#terminos" data-toggle="collapse" >
								<span class="float-left float-xl-right text-info">
									<b>Ver y firmar términos y condiciones</b>
								</span>
							</a>
						</div>
					</div>
				...
				<div id="terminos" class="collapse pb-4">
					<div class="card">
						...
						<div id="collapse1" class="collapse show" data-parent="#accordion">					
							<div class="card-body">						
								Para efectos de la interpretación del presente contrato de DISTRIBUCIÓN, los términos relevante usados en el mismo están definidos en el documento de Términos y Condiciones el cual usted aceptó y estuvo de acuerdo al registrarse en la página web www.academyoflife.com; los términos y palabras no definidas en el documento de Términos y Condiciones serán interpretadas pos su significado legal y técnico conforme a lo preceptuado en las leyes de cada país. 
							</div>
						</div>
